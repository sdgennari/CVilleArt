 ...
 * @author Alex Ramey
*/
public class TransportationPublicFragment extends Fragment 
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tabHost.addTab(publicMap, TransportationPublicMapFragment.class, null);
		tabHost.addTab(publicInfo,TransportationPublicInfoFragment.class, null);
