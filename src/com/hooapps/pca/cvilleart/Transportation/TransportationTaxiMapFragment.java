 ...
 * @author Alex Ramey
*/
public class TransportationTaxiMapFragment extends Fragment
{
	private TextView description;
	private static final String idea = "Possibly unnecessary fragment. Just here for now to provide symmetry.";
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.taxi_map, container, false);
	}
