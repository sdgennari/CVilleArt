 ...
 * @author Alex Ramey
*/
public class TransportationBikeMapFragment extends Fragment 
{
	private TextView description;
	private static final String idea = "Could show Blue Ridge Cyclery and CVille Bike and Tri as markers on map.";
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.bike_map, container, false);
	}
