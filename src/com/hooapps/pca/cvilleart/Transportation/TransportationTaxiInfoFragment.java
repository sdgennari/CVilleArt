...
/**
 * Loaded in when the appropriate tab is selected on the TransportationTaxiFragment.
 * Tier 3 Fragment
 * @author Alex Ramey
*/
public class TransportationTaxiInfoFragment extends Fragment
{
	private TextView description;
	private static final String idea = "Give some phone numbers for cab companies. Maybe recommend the TaxiMagic app.";
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.taxi_info, container, false);
	}
