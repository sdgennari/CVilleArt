 ...
 * @author Alex Ramey
*/
public class TransportationBikeFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tabHost.addTab(publicMap, TransportationBikeMapFragment.class, null);
		tabHost.addTab(publicInfo,TransportationBikeInfoFragment.class, null);
