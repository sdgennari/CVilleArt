 ...
 * @author Alex Ramey
*/
public class TransportationTaxiFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tabHost.addTab(publicMap, TransportationTaxiMapFragment.class, null);
		tabHost.addTab(publicInfo,TransportationTaxiInfoFragment.class, null);
